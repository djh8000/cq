		...
		this.btnStart.unbind('click').bind('click',function(){
			if(self.hasStart == 0){//不在游戏中
				...
				self.imgCells.unbind('touchstart').bind('touchstart',function(e){
					...
					var cell_mouse_x = e.targetTouches[0].pageX - self.imgCells.eq(cellIndex_1).offset().left;
					var cell_mouse_y = e.targetTouches[0].pageY - self.imgCells.eq(cellIndex_1).offset().top;
